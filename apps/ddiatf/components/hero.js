        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              TrustUK ensures individuals can share their information safely and
              easily. It provides a set of rules for organisations to follow,
              and empowers people to make informed decisions about the services
              they engage with.
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              >
                <Image
                  ...
                  alt={
                    "TrustSight logo, a stylised lighthouse with a handshake below it"
                  }
                />
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Certifies trust schemes across the UK
          </div>
