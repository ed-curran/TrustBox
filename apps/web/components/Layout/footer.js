      ...
      <div className="max-w-screen-xl w-full mx-auto px-6 sm:px-8 lg:px-16 grid grid-rows-6 sm:grid-rows-1 grid-flow-row sm:grid-flow-col grid-cols-3 sm:grid-cols-12 gap-4">
        <div className="row-span-2 sm:col-span-4 col-start-1 col-end-4 sm:col-end-5 flex flex-col items-start ">
          <div className={'flex space-x-2 items-center mb-6 w-auto'}>
            <Image alt="map" className="h-8" height={32} width={32} src={'/assets/dpdtf-logo-128.png'}/>
            <p className={'text-muted'}>Demo Property Data Trust Framework.</p>
        </div>
          <p className="mb-4">
            The <strong className="font-medium">Demo Property Data Trust Framework</strong> exists to demonstrate
